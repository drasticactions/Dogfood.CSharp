...
namespace Dogfood.CSharp.ObjectExtensions
{
	...
	{
		public new static string ToString(this CGPoint point)
		{
			return $"({point.X:#.00}, {point.Y:#.00})";
		}
		...
		{
			return self.Subtract(point).ComputeLength();
		}

		public static float ComputeLength(this CGPoint point) {
