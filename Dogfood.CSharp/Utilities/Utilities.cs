...
namespace Dogfood.CSharp.Extras
{
	public static class Utilities
	{
		...
		public static SCNVector3 AverageVector3List(List<SCNVector3> vectors)
		{
			...
			// Compute average
			average.X /= vectors.Count;
			average.Y /= vectors.Count;
			average.Z /= vectors.Count;
